...
const CHARACTERS: Record<CharacterId, CharacterProfile> = {
  pei: {
    ...
    role: "记忆重构师",
    image: "/pei-xubai.png",
    realImage: "/real-pei-xubai-v5.jpg",
    accent: "#d8bd82",
  ...
  yan: {
    ...
    realImage: "/real-xie-linyuan-v3.jpg",
    accent: "#b36d63",
  ...
  lu: {
    ...
    realImage: "/real-lu-tinglan-v4.jpg",
    accent: "#8fae9e",
  ...
  qi: {
    ...
    realImage: "/real-qi-linchuan-v3.jpg",
    accent: "#ba8a4e",
  ...
  shen: {
    ...
    realImage: "/real-shen-yanci-v4.jpg",
    accent: "#9796c4",
