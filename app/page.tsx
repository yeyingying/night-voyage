...
const CHARACTERS: Record<CharacterId, CharacterProfile> = {
  ...
  chi: {
    ...
    voiceStyle: "清爽利落 · 青年感 · 明亮笑意",
    voicePreview: "抓紧了。今天的风有点大，不过别怕，我会稳稳把你带回去。",
  ...
  yan: {
    ...
    voiceStyle: "清冷磁性 · 轻声戏谑 · 不压嗓",
    voicePreview: "别急着猜我在想什么。今晚，你只需要看着我。",
  ...
  lu: {
    ...
    voiceStyle: "松弛温暖 · 贴耳私语 · 无播音腔",
    voicePreview: "灯关小一点吧。今天不用急着想明白，先靠着，慢慢呼吸。",
